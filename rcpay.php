...
<body><div class="sg-ap-wrapper"><div class="sg-ap-box"><div class="sg-ap-header"></div>
        <div class="sg-container">
            <div class="sg-row">
                ...
                <br>
                <br>
                <button class="sg-btn sg-btn-flat-default"><a href="rcpay_add.php">新增資料</a></button>

                <table class="sg-table sg-table--responsive sg-table--bordered  sg-table--striped  sg-table--highlight">
                    <caption>應收帳款表</caption>
                    <thead>
                    <tr>
                        <th>客戶編號</th>
                        <th>前期結欠</th>
                    ...
                    while($row_result=mysqli_fetch_assoc($result)){
                        ...
                        echo "<td>".$row_result["PR_Upamt"]."</td>";
                        echo "<td>".$row_result["CR_Spamt"]."</td>";
                        echo "<td>".$row_result["CR_Csamt"]."</td>";
                        echo "<td>".$row_result["CR_Upamt"]."</td>";
                        echo "<td>".$row_result["UP_Time"]."</td>";
                        echo "<td><a href='rcpay_update.php?id=".$row_result["CU_No"]."'>修改</a> ";
                        echo "<a href='rcpay_delete.php?id=".$row_result["CU_No"]."'>刪除</a>";
                        echo "</tr>";
                    }
                    ?>
                </table>
                ...
                <table border="0" align="center">
                    <tr>
                        <?php if ($num_pages > 1) {  ?>
                            <td><a href="rcpay.php?page=1">第一頁</a></td>
                            <td><a href="rcpay.php?page=<?php echo $num_pages-1;?>">上一頁</a></td>
                        <?php } ?>
                        <?php if ($num_pages < $total_pages) {  ?>
                            <td><a href="rcpay.php?page=<?php echo $num_pages+1;?>">下一頁</a></td>
                            <td><a href="rcpay.php?page=<?php echo $total_pages;?>">最後頁</a></td>
                        <?php } ?>
                    </tr>
                </table>
                <table border="0" align="center">
                            ...
                            <div class="demo-btn-paragraph">
                                ...
                                for($i=1;$i<=$total_pages;$i++){
                                    if($i==$num_pages){
                                        ...
                                        echo "<button class='sg-btn sg-btn-default sg-btn-circle'>";
                                        echo "<a href=\"rcpay.php?page={$i}\" style=\"text-decoration:none;color:red;\">{$i}</a> ";
                                        echo "</button>";
                                    }
                                }
                                ?>
