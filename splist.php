        ...
        <div class="sg-container">
            <div class="sg-row">
                ...
                <div class="sg-btn-group">
                    <button class="sg-btn sg-btn-default"><a href="index.php">客戶資料表</a></button>
                ...
                <br>
                <br>
                <button class="sg-btn sg-btn-flat-default"><a href="splist_add.php">新增資料</a></button>
                ...
                <table class="sg-table sg-table--responsive sg-table--bordered  sg-table--striped  sg-table--highlight">
                    ...
                    while($row_result=mysqli_fetch_assoc($result)){
                        echo "<tr>";
                        echo "<td>".$row_result["SP_Blno"]."</td>";
                        echo "<td>".$row_result["CU_No"]."</td>";
                        echo "<td>".$row_result["PD_No"]."</td>";
                        echo "<td>".$row_result["SP_Qty"]."</td>";
                        echo "<td>".$row_result["TR_Note"]."</td>";
                        echo "<td>".$row_result["UP_Time"]."</td>";
                        echo "<td><a href='splist_update.php?id=".$row_result["SP_Blno"]."'>修改</a> ";
                        echo "<a href='splist_delete.php?id=".$row_result["SP_Blno"]."'>刪除</a>";
                        echo "</tr>";
                    }
                    ?>
                </table>
                ...
                <table border="0" align="center">
                    <tr>
                        <?php if ($num_pages > 1) {  ?>
                            <td><a href="splist.php?page=1">第一頁</a></td>
                            <td><a href="splist.php?page=<?php echo $num_pages-1;?>">上一頁</a></td>
                        <?php } ?>
                        <?php if ($num_pages < $total_pages) {  ?>
                            <td><a href="splist.php?page=<?php echo $num_pages+1;?>">下一頁</a></td>
                            <td><a href="splist.php?page=<?php echo $total_pages;?>">最後頁</a></td>
                        <?php } ?>
                    </tr>
                </table>
                <table border="0" align="center">
                            ...
                            <div class="demo-btn-paragraph">
                                ...
                                for($i=1;$i<=$total_pages;$i++){
                                    if($i==$num_pages){
                                        ...
                                        echo "<button class='sg-btn sg-btn-default sg-btn-circle'>";
                                        echo "<a href=\"splist.php?page={$i}\" style=\"text-decoration:none;color:red;\">{$i}</a> ";
                                        echo "</button>";
                                    }
                                }
                                ?>
